...
#   c) node1 mines 32 blocks, so now node 0 has 500000GITS, node 1 has 4250GITS, node2 has none.
#   d) node0 sends 601 GITS to node2, in two transactions (301 GITS, then 300 GITS).
