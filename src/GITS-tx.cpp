...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GitPay Core GITS-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  GITS-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded GITS transaction") + "\n" +
                               "  GITS-tx [options] -create [commands]   " + _("Create hex-encoded GITS transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded GITS transaction
