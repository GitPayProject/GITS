...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GITS features */
        {"GITS", "masternode", &masternode, true, true, false},
        {"GITS", "listmasternodes", &listmasternodes, true, true, false},
        {"GITS", "getmasternodecount", &getmasternodecount, true, true, false},
        {"GITS", "masternodeconnect", &masternodeconnect, true, true, false},
        {"GITS", "masternodecurrent", &masternodecurrent, true, true, false},
        {"GITS", "masternodedebug", &masternodedebug, true, true, false},
        {"GITS", "startmasternode", &startmasternode, true, true, false},
        {"GITS", "createmasternodekey", &createmasternodekey, true, true, false},
        {"GITS", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"GITS", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"GITS", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"GITS", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"GITS", "getmasternodescores", &getmasternodescores, true, true, false},
        {"GITS", "mnbudget", &mnbudget, true, true, false},
        {"GITS", "preparebudget", &preparebudget, true, true, false},
        {"GITS", "submitbudget", &submitbudget, true, true, false},
        {"GITS", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"GITS", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"GITS", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"GITS", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"GITS", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"GITS", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"GITS", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"GITS", "checkbudgets", &checkbudgets, true, true, false},
        {"GITS", "mnsync", &mnsync, true, true, false},
        {"GITS", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> GITS-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33359/\n";
}
