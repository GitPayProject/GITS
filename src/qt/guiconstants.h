...
/* GITS GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GITS"
#define QAPP_ORG_DOMAIN "GitPay.com"
#define QAPP_APP_NAME_DEFAULT "GITS-Qt"
#define QAPP_APP_NAME_TESTNET "GITS-Qt-testnet"
