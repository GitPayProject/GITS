                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GitPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GITS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and GITS: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GitPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about GitPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GITS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GITS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GITS addresses"));
    ...
    openAction->setStatusTip(tr("Open a GITS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GitPay Core help message to get a list with possible GITS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GitPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GITS network", "", count));
}
...
{
    QString strTitle = tr("GitPay Core"); // default title
