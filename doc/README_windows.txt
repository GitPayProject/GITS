...
Intro
-----
GITS (GITS) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. GITS utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run GITS-qt.exe.

GitPay Core is the original GITS client and it builds the backbone of the network.
However, it downloads and stores the entire history of GITS transactions;
