...
In order to support loading of multiple wallets in GITS-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is GITS.cpp.
...
Changes to GITS.cpp
----------------------
GITS.cpp is the entry point into GITS-qt, and as such, will require some minor modifications to provide hooks for
