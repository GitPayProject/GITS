...
RESOURCES += src/qt/GITS.qrc src/qt/GITS_locale.qrc

TRANSLATIONS += src/qt/locale/GITS_bg.ts \
                src/qt/locale/GITS_de.ts \
                src/qt/locale/GITS_en.ts \
                src/qt/locale/GITS_es.ts \
                src/qt/locale/GITS_fi.ts \
                src/qt/locale/GITS_fr.ts \
                src/qt/locale/GITS_it.ts \
                src/qt/locale/GITS_ja.ts \
                src/qt/locale/GITS_pl.ts \
                src/qt/locale/GITS_pt.ts \
                src/qt/locale/GITS_ru.ts \
                src/qt/locale/GITS_sk.ts \
                src/qt/locale/GITS_sv.ts \
                src/qt/locale/GITS_vi.ts \
                src/qt/locale/GITS_zh_CN.ts \
                src/qt/locale/GITS_zh_TW.ts
