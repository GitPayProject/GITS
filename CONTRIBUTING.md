Contributing to GitPay Core
==================================

The GitPay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GitPay Core project, and is not to be
confused with overall GITS Network Protocol consensus changes.

Whether a pull request is merged into GitPay Core rests with the project merge
...
Patches that change GITS consensus rules are considerably more involved than
...
Where a patch set proposes to change the GITS consensus, it must have been
...
The project leader is the release manager for each GitPay Core release.
